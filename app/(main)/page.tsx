...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered insights for lab results, prescriptions, and symptoms. Transform your healthcare experience with intelligent technology designed for Nigerian communities.",
  keywords:
    "AI healthcare, Nigerian medical care, healthcare diagnostics, medical AI, telemedicine Nigeria, health technology, medical innovation",
  authors: [
    { name: "InfoRx Team" },
    { name: "Chinyere Unamba", url: "chinyereunamba.vercel.app" },
  ],
  creator: "Chinyere Unamba",
  publisher: "InfoRx",
  robots: "index, follow",
  openGraph: {
    type: "website",
    ...
    title: "InfoRx - Simplifying Healthcare Through Intelligent Innovation",
    description:
      "AI-powered insights for lab results, prescriptions, and symptoms. Transform your healthcare experience with intelligent technology.",
    siteName: "InfoRx",
  },
  twitter: {
