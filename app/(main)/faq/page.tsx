  ...
  const faqCategories: FaqCategory[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Yes, InfoRx currently supports English and Nigerian Pidgin, with plans to add more Nigerian languages in the future. Our AI interpreter is specially trained to understand medical terminology in these languages and provide clear explanations that respect cultural context.",
          icon: Globe,
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Only you have access to your medical data by default. No one at InfoRx, including administrators, can view your personal health information without your explicit permission. You can choose to securely share specific records with healthcare providers through our sharing feature, which allows you to control exactly what information is shared and for how long.",
          icon: User,
        },
      ],
    },
      ...
      items: [
        {
          ...
          answer:
            "InfoRx is accessible on any device with an internet connection and web browser, including desktop computers, laptops, tablets, and smartphones. Our platform is fully responsive and optimized for all screen sizes. For the best experience, we recommend using the latest version of Chrome, Firefox, Safari, or Edge.",
          icon: Smartphone,
        },
        {
          id: "app",
          ...
          answer:
            "Currently, InfoRx is available as a web application that works excellently on mobile browsers. A dedicated mobile app for iOS and Android is under development and scheduled for release in Q4 2025. The web version is fully mobile-responsive and offers all features available on desktop.",
          icon: Smartphone,
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Yes, you can download individual medical records or export your entire medical history at any time. InfoRx supports exports in PDF, CSV, and structured medical formats like CCD (Continuity of Care Document). This feature ensures you maintain complete control over your medical information and can easily share it with healthcare providers.",
          icon: Download,
        },
      ],
    },
      ...
      items: [
        {
          ...
          answer:
            "InfoRx offers a freemium model. Basic features including document uploads, storage, and basic interpretations are available for free. Premium features like advanced health insights, unlimited document storage, and priority support require a subscription starting at ₦2,500 per month. We also offer special pricing for healthcare providers and organizations.",
          icon: CreditCard,
        },
        {
          id: "support",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={headerRef} className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Find answers to common questions about InfoRx, our healthcare
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-slate-600 text-sm mb-4">
                  New to InfoRx? Learn how to use our platform with our
                  step-by-step guide.
                </p>
                <a
                  href="/demo"
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-slate-600 text-sm mb-4">
                  Sign up for free and start managing your healthcare
                  information.
                </p>
                <a
                  href="/auth/signup"
