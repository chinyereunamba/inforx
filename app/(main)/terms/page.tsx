      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={headerRef} className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            These terms govern your use of InfoRx and outline our mutual
            responsibilities. Please read them carefully before using our
            services.
          </p>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div className="flex items-start gap-2">
              ...
              <span>
                InfoRx is not a substitute for professional medical advice
              </span>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2" />
        ...
        <div className="prose prose-slate max-w-none">
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              By accessing or using the InfoRx platform, website, mobile
              application, or any other related services (collectively, the
              "Services"), you agree to be bound by these Terms of Service. If
              you don't agree to these terms, please do not use our Services.
            </p>
            <p className="text-slate-700 leading-relaxed">
              These Terms constitute a legal agreement between you and InfoRx, a
              healthcare technology company registered in Nigeria. You must be
              at least 18 years old and capable of forming a binding contract to
              use our Services.
            </p>
          </section>
          ...
          >
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-slate-700">
              ...
              <li>
                Ensuring you exit from your account at the end of each session
                when accessing InfoRx on shared devices
              </li>
            </ul>
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              Subject to these Terms, InfoRx grants you a limited,
              non-exclusive, non-transferable, and revocable license to:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-slate-700">
              <li>
                Access and use our Services for your personal, non-commercial
                health information needs
              </li>
              <li>
                Upload and store your medical documents for interpretation and
                record-keeping
              </li>
              <li>
                View AI-generated summaries and explanations of your medical
                information
              </li>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700">
                <li>
                  Upload or share medical documents or information of other
                  individuals without proper authorization
                </li>
                <li>Violate any applicable laws or regulations</li>
                <li>Impersonate another person or entity</li>
                <li>
                  Engage in any activity that could harm, disable, or impair our
                  Services
                </li>
                <li>
                ...
                <li>
                  Use the Services for commercial purposes without our prior
                  written consent
                </li>
                <li>
                  Upload content that is illegal, harmful, threatening, or
          ...
          >
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 mb-4">
              ...
              <p className="text-amber-700">
                <strong>InfoRx is not a healthcare provider.</strong> The
                information and services provided by InfoRx are not intended to
                replace professional medical advice, diagnosis, or treatment.
                Always seek the advice of qualified healthcare providers with
                any questions regarding your medical condition. Never disregard
                professional medical advice or delay seeking it because of
                information provided by InfoRx.
              </p>
            </div>
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              InfoRx is not designed for emergency medical situations. If you
              are experiencing a medical emergency, please contact your local
              emergency services immediately, such as by dialing 112 or 999 in
              Nigeria, or going to the nearest hospital emergency department.
            </p>
          </section>
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              You retain all ownership rights to the medical documents and
              information you upload to InfoRx. By uploading content, you grant
              us a limited license to store, process, and analyze your content
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              completeness of the information you provide. We do not verify the
              accuracy of the medical documents you upload or the information
              you provide.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed">
              Our platform allows you to control who can access your medical
              information. You are responsible for managing these sharing
              permissions and understanding the implications of sharing your
              medical records.
            </p>
          </section>
          ...
          >
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-slate-700">
              ...
              <li>
                The design, structure, and layout of our website and
                applications
              </li>
              <li>
                Text, graphics, images, and other content created by InfoRx
              </li>
            </ul>
            ...
            <p className="text-slate-700 leading-relaxed">
              We grant you a limited license to use our Services for personal,
              non-commercial purposes in accordance with these Terms. You may
              not copy, modify, distribute, sell, or lease any part of our
              Services or included software without our permission.
            </p>
          </section>
          ...
          >
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700">
                <li>
                  InfoRx provides its services "as is" and "as available"
                ...
                <li>
                  InfoRx makes no warranty that its services will meet your
                  requirements or be available on an uninterrupted, secure, or
                  error-free basis.
                </li>
                <li>
                  InfoRx disclaims all liability for any harm or damages arising
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              You agree to defend, indemnify, and hold harmless InfoRx and its
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              You can stop using our Services and delete your account at any
              time through your account settings. Upon deletion, we will remove
              your personal information and medical records in accordance with
              our Privacy Policy.
            </p>

            <h3 className="text-xl font-medium text-slate-800 mb-3">
              InfoRx Termination Rights
            </h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-slate-700">
              ...
              <li>
                If we reasonably believe your use poses a risk to InfoRx or
                other users
              </li>
              <li>
                For extended periods of account inactivity (with prior notice)
              </li>
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              Before filing a claim against InfoRx, you agree to try to resolve
              the dispute informally by contacting us at legal@inforx.ng. We'll
              try to resolve the dispute informally by contacting you via email.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              If we cannot resolve a dispute informally within 60 days, either
              party may initiate formal proceedings. Any legal proceeding shall
              be brought solely in the courts of Nigeria.
            </p>
          </section>
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              our services, legal requirements, or for other reasons. We will
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              Your continued use of InfoRx after changes become effective
              constitutes your acceptance of the updated Terms. If you do not
              agree with the updated Terms, you must stop using our Services.
            </p>
          </section>
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed">
              These Terms shall comply with the Nigeria Data Protection
              Regulation (NDPR) and other applicable Nigerian laws relating to
