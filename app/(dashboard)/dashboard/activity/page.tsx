...
export default function ActivityPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold font-noto text-gray-900 mb-2">Activity Timeline</h1>
        <p className="text-gray-600 max-w-3xl">
          Track your activity history and interactions with InfoRx. This helps you monitor your healthcare journey and understand how you're using the platform over time.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 flex flex-col items-center text-center">
            ...
            <div className="text-2xl font-semibold">{activityStats.thisWeek}</div>
        ...
        <Card>
          <CardContent className="p-4 flex flex-col items-center text-center">
            ...
            <div className="text-2xl font-semibold">{activityStats.thisMonth}</div>
