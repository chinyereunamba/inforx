          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-3 text-slate-700 leading-relaxed">
                <p>
                  <strong>
                    InfoRx is an AI-powered health information platform designed
                    to assist and educate.
                  </strong>
                  Our technology provides general health information and
                ...
                <p>
                  ...
                  medical concerns. In case of medical emergencies, contact your
                  local emergency services immediately. InfoRx's AI
                  recommendations should be used as supplementary information
                  alongside professional medical care.
                </p>

                <div className="bg-amber-50 rounded-lg p-4 mt-4">
                  <p className="text-sm font-medium text-amber-800">
                    <strong>Important:</strong> This platform is not intended to
                    diagnose, treat, cure, or prevent any disease. Individual
                    results may vary, and medical decisions should always
                    involve healthcare professionals.
                  </p>
                </div>

                <p className="text-sm text-slate-600">
                  This platform is designed to provide general health
                  information and should not replace professional medical
                  advice. Always consult with qualified healthcare providers for
