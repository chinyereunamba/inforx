        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {partners.map((partner, index) => {
            ...
            return (
              ...
              >
                <div className={`w-16 h-16 bg-gradient-to-br ${partner.color} rounded-2xl flex items-center justify-center mx-auto mb-6`}>
        ...
        <div ref={collaborationsRef}>
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-slate-200 text-center">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-4xl mx-auto leading-relaxed">
              Our partnerships span across medical institutions, government bodies, 
              and community organizations. Together, we're supported by local medical 
              associations, tech accelerators, and community health organizations 
              committed to improving healthcare accessibility for all Nigerians.
            </p>
