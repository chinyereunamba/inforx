...
const problems: ProblemPoint[] = [
  {
    ...
    description:
      "Healthcare information is often too complex for patients to understand",
  ...
  },
  {
    ...
    description:
      "Geographic and economic barriers prevent timely healthcare access",
  ...
  },
  {
    ...
    description:
      "Long waiting times and rushed consultations compromise care quality",
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (sectionRef.current) {
        staggerChildren(sectionRef.current, ".problem-card");
      }
    }, sectionRef);
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-700 max-w-3xl mx-auto">
            Traditional healthcare faces significant barriers that prevent
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {problems.map((problem, index) => {
            const IconComponent =
              iconComponents[problem.id as keyof typeof iconComponents];
