...
import type { DashboardState, InterpretationResult } from '@/lib/types/dashboard';
...
export default function DashboardLayout() {
  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (state.sidebarOpen && !target.closest('[data-sidebar]') && window.innerWidth < 1024) {
        setState(prev => ({ ...prev, sidebarOpen: false }));
      }
    };
      ...
      <div className="flex-1 flex flex-col lg:ml-64">
        ...
        <header className="lg:hidden bg-white border-b border-gray-200 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-semibold text-gray-900">InfoRx Dashboard</h1>
        ...
        <main className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          {/* Left Panel - Interpreter Interface */}
