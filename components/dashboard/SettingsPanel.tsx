            ...
            <Card className="settings-card border border-slate-200">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="text-lg font-medium text-slate-900">Theme Mode</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                  <div className="p-4 bg-white rounded-lg border border-slate-200 shadow-md">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-medium text-slate-900 mb-1">Light Mode</h3>
                      <p className="text-sm text-slate-600">
                  ...
                  <div className="p-4 bg-slate-800 rounded-lg border border-slate-700 shadow-md">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-medium text-white mb-1">Dark Mode</h3>
                ...
                <Button onClick={handleSaveSettings} className="mt-4 bg-emerald-600 hover:bg-emerald-700">
                  Save Preferences
                </Button>
              </CardContent>
            </Card>
