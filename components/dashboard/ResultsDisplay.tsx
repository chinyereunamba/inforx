...
RECOMMENDED ACTIONS:
${result.interpretation.recommendedActions
  .map((action, i) => `${i + 1}. ${action}`)
  .join("\n")}

MEDICAL ATTENTION INDICATORS:
${result.interpretation.medicalAttentionIndicators
...
This interpretation is for educational purposes only and should not replace professional medical advice.
    ...
    a.href = url;
    a.download = `inforx-interpretation-${result.id || "result"}.txt`;
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Our AI is processing your medical information...
          </p>
      ...
      <div className="h-full flex items-center justify-center bg-gray-50 p-6">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600">
            Upload a medical document or paste text to get started with
      ...
      <div ref={resultsRef} className="p-6">
        ...
        <div className="results-header mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold font-noto text-gray-900">
                Analysis Results
              </h1>
              <p className="text-gray-600">
                Generated on {result.timestamp.toLocaleDateString()} •{" "}
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                <Volume2
                  className={`w-4 h-4 ${isSpeaking ? "text-blue-600" : ""}`}
                />
                    ...
                    {Array.isArray(section.content) ? (
                      <ul className="space-y-3">
                        {section.content.map((item, itemIndex) => (
                          ...
                          >
                            <div
                              className={`w-6 h-6 ${bgColor} rounded-full flex items-center justify-center flex-shrink-0 mt-0.5`}
                            >
                              <span
                                className={`${iconColor} font-semibold text-sm`}
                              >
                                {itemIndex + 1}
                              </span>
                            </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 leading-relaxed">
                This interpretation is for educational purposes only and should
                not replace professional medical advice. Always consult with
                qualified healthcare providers for medical decisions, diagnosis,
                and treatment plans. In case of medical emergencies, contact
