...
import { ArrowUp, Download, Play, Users, Star, TrendingUp, Award } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div ref={ctaRef} className="text-center">
            ...
            <div className="pt-8 border-t border-emerald-400">
              <p className="text-emerald-200 text-sm mb-4">Trusted by leading healthcare institutions</p>
              <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                ...
                <div className="text-white font-semibold">Federal Ministry of Health</div>
              </div>
            </div>
          </div>
        </div>
